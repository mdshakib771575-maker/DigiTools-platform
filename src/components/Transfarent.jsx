            ...
            <div className='border flex flex-col lg:flex-row w-11/12 mx-auto gap-6'>
                <div className="card w-full bg-base-100 shadow-2xl">
                    <div className="card-body">
                            ...
                            <span className="text-xl"> <span className='text-2xl font-bold'>$29</span>/mo</span>
                        ...
                        <div className="mt-6">
                            <button className="btn bg-linear-to-r from-purple-700 to-purple-500 btn-block text-white rounded-full">Subscribe</button>
                        </div>
                    </div>
                </div>
