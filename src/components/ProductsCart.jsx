    ...
    <div>
      ...
      <div className="card bg-base-100 shadow-xl border">
        <div className="card-body ">
          ...
          <div className="mt-6">
            <button onClick={() => handalarCardBtn()} className={`btn w-full rounded-full  text-white ${isBayNaw === true ? "bg-green-600" : "bg-linear-to-r from-purple-700 to-purple-500"}`}>
              {
